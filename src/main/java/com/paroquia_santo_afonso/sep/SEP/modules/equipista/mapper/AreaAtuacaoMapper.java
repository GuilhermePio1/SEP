...
public class AreaAtuacaoMapper {
    ...
    public AreaAtuacaoDTO toDTO(AreaAtuacao entity) {
        return AreaAtuacaoDTO.builder()
                .formacao(Optional.ofNullable(entity.getFormacao()).map(Formacao::name).orElse(null))
                .profissao(Optional.ofNullable(entity.getProfissao()).map(Profissao::name).orElse(null))
                .ocupacao(Optional.ofNullable(entity.getOcupacao()).map(Ocupacao::name).orElse(null))
